...
library.add(faHatWizard, faPerson, faPersonWalking, faCircleCheck, faTrash, faCircleXmark);
  ...
  <div class="p-5 min-h-screen bg-gray-100">
    <div class="bg-slate-600 flex items-center justify-between p-6">
      <div class="flex items-center">
        ...
        <font-awesome-icon class="ml-3 mr-3" :icon="['fas', 'person']" bounce size="2xl" style="color: #fff;" />
      </div>
      <div>
        ...
        <li class="flex items-center mt-4 transition-all hover:scale-95 hover:shadow-lg p-5 min-w-full justify-between h-14" :class="routine.state === 'Completa' ? 'bg-green-300': 'bg-red-300'" v-for="(routine, i) of rutina" :key="i">
          ...
          <div>
            <span>
                ...
                <div>
                  <font-awesome-icon @click="changeStateTrue(routine.id)" class="cursor-pointer mr-4 active:translate-y-1" :icon="['fas', 'circle-check']" size="xl" style="color: #475569;" />
                  <font-awesome-icon @click="changeStateFalse(routine.id)" class="cursor-pointer mr-4 active:translate-y-1" :icon="['fas', 'circle-xmark']" size="xl" style="color: #475569;" />
                  <font-awesome-icon @click="deleteExercise(routine.id)" class="cursor-pointer active:translate-y-1" :icon="['fas', 'trash']" size="xl" style="color: #475569;" />
                  </div>
